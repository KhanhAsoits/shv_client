      ...
      <Container>
        <div className='flex justify-between items-center'>
          <div className='flex items-center justify-between'>
            ...
            <div className='px-4 py-6 font-semibold cursor-pointer hover:bg-[#edf0f0] relative group hover:after:block after:hidden after:content-[""] after:absolute after:bottom-0 after:right-1/2 after:translate-x-1/2 after:border-8 after:border-transparent after:border-b-white'>
              <span>
            ...
            <div className='px-4 py-6 font-semibold cursor-pointer hover:bg-[#edf0f0] relative group hover:after:block after:hidden after:content-[""] after:absolute after:bottom-0 after:right-1/2 after:translate-x-1/2 after:border-8 after:border-transparent after:border-b-white'>
              <Link to='bang-xep-hang' className=''>
                      ...
                      rankItem.map((item, index) => {
                        return (
                          <Link
                            to={item.path}
                            key={index}
                            className='w-full py-1.5 px-4 text-[#212529] hover:text-textHover'
                          >
                            {item.content}
                          </Link>
                        );
          ...
          <div
            className={`flex items-center relative rounded-full border-3 ${
          ...
          >
            <input
              ...
              className='py-1.5 pl-6 pr-14 h-10 rounded-full'
          ...
          <div>
            <span
              to='/'
              className='px-4 py-2 hover:text-textHover cursor-pointer'
            >
